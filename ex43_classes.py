...
class CentralCorridor(Scene):
	...
	def enter(self):
		print(dedent("""
			The Gothons of Planet Percal #25 have invaded your ship 6 destroyed 
	...
	def enter(self):
		...
		if action == "throw the bomb":
			print(dedent("""
				...
				and make a leap for the door. Right as you drop it 61 Gothon shoots you right in the back killing you. As
